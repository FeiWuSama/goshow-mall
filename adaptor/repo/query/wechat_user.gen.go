...
func newWechatUser(db *gorm.DB, opts ...gen.DOOption) wechatUser {
	...
	_wechatUser.WechatUserID = field.NewInt64(tableName, "wechat_user_id")
...
type wechatUser struct {
	...
	WechatUserID field.Int64 // 微信用户uuid
	Avatar       field.String
...
func (w *wechatUser) updateTableName(table string) *wechatUser {
	...
	w.WechatUserID = field.NewInt64(table, "wechat_user_id")
...
func (w *wechatUser) fillFieldMap() {
	...
	w.fieldMap["wechat_user_id"] = w.WechatUserID
