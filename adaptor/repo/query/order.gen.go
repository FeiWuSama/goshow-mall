...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.OrderOrginalAmount = field.NewInt64(tableName, "order_orginal_amount")
	_order.PaymentAmount = field.NewInt64(tableName, "payment_amount")
	_order.TradeNumber = field.NewString(tableName, "trade_number")
	_order.InnerTradeNumber = field.NewString(tableName, "inner_trade_number")
	...
	_order.ConfirmAt = field.NewInt64(tableName, "confirm_at")
	_order.ConfirmType = field.NewInt32(tableName, "confirm_type")
...
type order struct {
	...
	OrderSource        field.Int32  // 1：用户下单，2：管理后台，3：活动赠送
	OrderAmount        field.Int64  // 订单金额
	OrderOrginalAmount field.Int64  // 订单原始金额
	PaymentAmount      field.Int64  // 订单支付金额
	TradeNumber        field.String // 交易号
	InnerTradeNumber   field.String // 内部交易号
	OrderDesc          field.String // 订单描述
	PaymentAt          field.Int64  // 订单交易时间
	UserRemark         field.String // 用户备注
	ConfirmAt          field.Int64  // 收货时间
	ConfirmType        field.Int32  // 收货类型，1：用户确认，2：自动发货
	RefundAmount       field.Int64  // 订单退款金额
	RefundAt           field.Int64  // 退款时间
	CancelAt           field.Int64  // 取消时间
	CancelBy           field.Int64  // 退款用户id
	CancelType         field.Int32  // 1：用户取消，2：超时取消，3：客服取消
...
func (o *order) updateTableName(table string) *order {
	...
	o.OrderOrginalAmount = field.NewInt64(table, "order_orginal_amount")
	o.PaymentAmount = field.NewInt64(table, "payment_amount")
	o.TradeNumber = field.NewString(table, "trade_number")
	o.InnerTradeNumber = field.NewString(table, "inner_trade_number")
	...
	o.ConfirmType = field.NewInt32(table, "confirm_type")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["order_orginal_amount"] = o.OrderOrginalAmount
	o.fieldMap["payment_amount"] = o.PaymentAmount
	o.fieldMap["trade_number"] = o.TradeNumber
	o.fieldMap["inner_trade_number"] = o.InnerTradeNumber
	...
	o.fieldMap["confirm_type"] = o.ConfirmType
