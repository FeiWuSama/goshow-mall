...
func newSmsTemplate(db *gorm.DB, opts ...gen.DOOption) smsTemplate {
	...
	_smsTemplate.PlatformTmpID = field.NewInt32(tableName, "platform_tmp_id")
	_smsTemplate.TmpContent = field.NewString(tableName, "tmp_content")
	...
	_smsTemplate.UserID = field.NewInt64(tableName, "user_id")
...
type smsTemplate struct {
	...
	ALL           field.Asterisk
	ID            field.Int64
	SceneCode     field.String // 场景编码
	SignName      field.String // 短信签名
	PlatformTmpID field.Int32  // 短信平台的模板id
	TmpContent    field.String // 短信模板内容
...
func (s *smsTemplate) updateTableName(table string) *smsTemplate {
	...
	s.PlatformTmpID = field.NewInt32(table, "platform_tmp_id")
	s.TmpContent = field.NewString(table, "tmp_content")
...
func (s *smsTemplate) fillFieldMap() {
	...
	s.fieldMap["platform_tmp_id"] = s.PlatformTmpID
	s.fieldMap["tmp_content"] = s.TmpContent
